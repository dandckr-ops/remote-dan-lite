...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("41 05 3E", "Engine coolant temperature", pytest.approx(71.6), "°F"),
        ("41 0B 64", "Intake manifold pressure", pytest.approx(14.5038, abs=0.0001), "psi"),
        ("41 0C 1A F8", "Engine speed", 1726.0, "rpm"),
        ("41 0D 58", "Vehicle speed", pytest.approx(54.6807, abs=0.0001), "mph"),
        ("41 0F 50", "Intake air temperature", pytest.approx(104.0), "°F"),
        ("41 10 01 7C", "Mass air flow", pytest.approx(0.5027, abs=0.0001), "lb/min"),
